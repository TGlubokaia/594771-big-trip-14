...
/* harmony import */ var _view_route_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/route.js */ "./src/view/route.js");
/* harmony import */ var _view_header_trip_info_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/header-trip-info.js */ "./src/view/header-trip-info.js");
/* harmony import */ var _view_price_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/price.js */ "./src/view/price.js");
/* harmony import */ var _view_trips_list_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/trips-list.js */ "./src/view/trips-list.js");
/* harmony import */ var _view_form_create_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/form-create.js */ "./src/view/form-create.js");
...
/*!***************************!*\
  !*** ./src/mock/point.js ***!
  \***************************/
/*! exports provided: pointName, optionFlight, createPoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pointName", function() { return pointName; });
...
const pointName = ['Paris', 'New-York', 'London', 'Thorshavn', 'Santiago'];
...
const photosArr = function() {
  const photos = [];
  for (let i = 0; i <= 5; i++) {
    photos.push(`http://picsum.photos/248/152?r=${Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, 450)}`);
  }
  return photos;
};
...
const createPoint = function () {
  ...
  const start = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFormat + 'T' + startTime[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, startTime.length-1)]);
  const end = dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFormat + 'T' + endTime[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, endTime.length-1)]);

  return {
    type: pointType[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, pointType.length-1)],
    offers: offers[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, offers.length-1)]['offers'],
    point: pointName[Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(0, pointName.length-1)],
    description: description.slice(0, Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(1, description.length)).join('. ') + '.',
    photos: photosArr(),
    date: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(dateFormat).format('MMM DD').toUpperCase(),
    price: Object(_utils_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(10, 150),
...
/***/ "./src/view/destination-item.js":
/*!**************************************!*\
  !*** ./src/view/destination-item.js ***!
  \**************************************/
/*! exports provided: createRouteItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createRouteItem", function() { return createRouteItem; });
const createRouteItem =  function (item) {
...
/*!*******************************!*\
  !*** ./src/view/form-edit.js ***!
  \*******************************/
/*! exports provided: createFormEdit */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createFormEdit", function() { return createFormEdit; });
...
const createFormEdit =  function () {
  const {type, point, offers, description, dateFormat, startTime, endTime, price, photos} = Object(_mock_point_js__WEBPACK_IMPORTED_MODULE_0__["createPoint"])();
  ...
  const createOption = function() {
    let options = '';
    for (const point of _mock_point_js__WEBPACK_IMPORTED_MODULE_0__["pointName"]) {
...
/*!**************************************!*\
  !*** ./src/view/header-trip-info.js ***!
  \**************************************/
/*! exports provided: createHeaderInfo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createHeaderInfo", function() { return createHeaderInfo; });
...
/*!********************************!*\
  !*** ./src/view/trips-list.js ***!
  \********************************/
/*! exports provided: createTripsList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createTripsList", function() { return createTripsList; });
const createTripsList =  function () {
