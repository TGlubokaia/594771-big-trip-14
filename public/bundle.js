...
render(siteTripsList, Object(_view_form_edit_js__WEBPACK_IMPORTED_MODULE_8__["createFormEdit"])(), 'afterbegin');

for (let i = 0; i < 3; i++) {
  render(siteTripsList, Object(_view_destination_item_js__WEBPACK_IMPORTED_MODULE_9__["createRouteItem"])(), 'beforeend');
}
...
const createRouteItem =  function () {
